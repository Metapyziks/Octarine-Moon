...
PLUGIN.Privileges = { "Ignite", "Ignite Self" }

function PLUGIN:Call( ply, args )
	local players = evolve:FindPlayer( args, ply, true )
	if ( ply:EV_HasPrivilege( "Ignite" ) or ( #players == 1 and ply == players[ 1 ] and ply:Alive() and ply:EV_HasPrivilege( "Ignite Self" ))) then
